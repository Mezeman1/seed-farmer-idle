...
<template>
    ...
    <nav class="fixed bottom-0 left-0 right-0 bg-green-800 text-white z-20">
        <div class="flex justify-around items-center h-16">
            <!-- Home Button -->
            <a href="#" class="flex flex-col items-center justify-center w-1/2 h-full hover:bg-green-700">
            ...
            <button @click="showSettingsDialog = true"
                class="flex flex-col items-center justify-center w-1/2 h-full hover:bg-green-700">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
